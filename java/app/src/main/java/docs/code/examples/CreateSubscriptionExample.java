...
import io.hstream.Subscription.SubscriptionOffset;
...
public class CreateSubscriptionExample {
  ...
  public static void createSubscriptionExample(HStreamClient client, String streamName) {
    ...
    Subscription subscription =
        Subscription.newBuilder().subscription(subscriptionId).stream(streamName).offset(SubscriptionOffset.LATEST)
            .ackTimeoutSeconds(10) // The default setting is 600 seconds
            .maxUnackedRecords(100) // The default setting is 10000 records
            .build();
